	...
	$.fn.GGame = function (options={}) {
        ...
        function init(obj) {
          	...
          	$(obj).css("position", "relative").append("<div id='sprite1' style='position: absolute'>");
		      	$("#"+default_values.subchild_id).css({"backgroundImage":"url("+"./images/sprint1.png"+")","min-height":default_values.height,"max-height":default_values.height,"min-width":default_values.width,"max-width":default_values.width});
